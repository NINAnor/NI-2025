...
```{r, echo = FALSE}
theme_acidification <- readRDS("data/NI2025_Data_Freshwater_themeAcidification.rds")
```
...
```{r, echo = FALSE}
theme_eutrophication <- readRDS("data/NI2025_Data_Freshwater_themeEutrophication.rds")
```
