# Indicator data: calculations and visualizations
...
saveRDS(TS_indIdx_std, file = "results_Indicators/PlotList_TimeSeries_indIdx_std.rds")
```
...
TS_indIdx <- readRDS("results_Indicators/PlotList_TimeSeries_indIdx.rds")
TS_indIdx_std <- readRDS("results_Indicators/PlotList_TimeSeries_indIdx_std.rds")
```
...
```{r, results = "asis", echo = FALSE, eval = FALSE, out.width = '50%'}
...
for(i in 1:nrow(indicatorList)){
  ...
  #indIdx_file <- paste0(savePath_i, "/TimeSeries_indIdx.svg")
  #indIdx_file <- paste0(savePath_i, "/TimeSeries_indIdx_std.svg")
  
  raw_file <- paste0(savePath_i, "/TimeSeries_raw.png")
  scaled_file <- paste0(savePath_i, "/TimeSeries_scaled.png")
  indIdx_file <- paste0(savePath_i, "/TimeSeries_indIdx.png")
  indIdx_std_file <- paste0(savePath_i, "/TimeSeries_indIdx_std.png")
...
for(i in 1:nrow(indicatorList)){
  ...
  indIdx_file <- paste0(savePath_i, "/TimeSeries_indIdx.pdf")
  indIdx_std_file <- paste0(savePath_i, "/TimeSeries_indIdx_std.pdf")
  
  cat("\n\n### ", indicatorList$name[i], "\n\n")
  cat("![](", raw_file, "){height=4in}\n\n")
  cat("![](", scaled_file, "){height=4in}\n\n")
  cat("![](", indIdx_file, "){height=4in}\n\n")
  cat("![](", indIdx_std_file, "){height=4in}\n\n")
}
