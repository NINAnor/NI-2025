...
Updating the indicator data calculations in the database (chapter 1, "01_IndicatorData_updates.Rmd") requires write access. All other parts of the workflow should be possible to run with read/download access only. 
