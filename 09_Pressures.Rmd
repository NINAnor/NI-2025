---
title: "Pressure factor analysis"
...
for (i in 1:length(ecosystems)){
  ...
  eco_NIobject <- readRDS(paste0("NI2025_Data_", ecosystems[i], ".rds"))
...
## Set color palette
plot.palette <- c("#8B9742", "#2b6EAA", "#004B46", "#A57082", "#FF7D00")
